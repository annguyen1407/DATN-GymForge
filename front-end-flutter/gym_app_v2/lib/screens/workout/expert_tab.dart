...
/// ExpertTab: hiển thị các kế hoạch gắn với trainingRequest (contract) => trainingRequestId != null
class ExpertTab extends StatefulWidget {
  final bool isActive; // parent có thể truyền để lazy load
  const ExpertTab({super.key, this.isActive = false});

  @override
  State<ExpertTab> createState() => _ExpertTabState();
}

class _ExpertTabState extends State<ExpertTab> {
  ...
  @override
  void didUpdateWidget(covariant ExpertTab oldWidget) {
      ...
      children: [
        FutureBuilder<List<WorkoutPlanModel>>(
          ...
          builder: (context, snapshot) {
            ...
            // Chỉ kế hoạch có trainingRequestId != null (gắn hợp đồng) và không phải template
            final data = rawData
